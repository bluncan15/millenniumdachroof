        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-3 gap-3 mb-3 md:grid-cols-4 md:mb-4">
                  {colorOptions.map((color) => (
                    <button
                      key={color.code}
                      onClick={() => setSelectedColor(color.code)}
                      className={`w-10 h-10 md:w-24 md:h-24 group relative aspect-square rounded-lg border-2 transition-all hover:scale-105 ${
